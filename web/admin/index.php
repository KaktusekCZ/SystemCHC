          ...
          ?>
                    <div class="admin__bar">
                        <div class="admin__bar__status">
                            ...
                            <?php if($accRow["type"] == 1) : ?>
                            <div class="admin__bar__item admin__bar__item--grade"><span><i class="fas fa-users"></i> Třída</span>
                                <?php echo getAccountGrade($groupRow); ?>
                            </div>
                            <?php endif; ?>
                            <div class="admin__bar__item admin__bar__item--name"><span><i class="fas fa-user"></i> Přihlášen</span>
                                <?php echo $accRow["name"] ?>
                            </div>
