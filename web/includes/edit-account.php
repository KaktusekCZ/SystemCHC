                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="input-group mb-3 col-lg-4 col-md-12">
                            ...
                            <input type="password" name="password" autocomplete="current-password" class="form-control login__password" placeholder="Nové heslo" aria-label="Nové heslo" aria-describedby="login_password" required="required">
                        </div>
