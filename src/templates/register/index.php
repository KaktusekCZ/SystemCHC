...
<div class="login">
    <div class="login__wrapper">
        <div class="login__loader js-login-loader"><div class="login__loader__inner"></div></div>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <?php
                    ...
                    <form class="registry__form" id="registry">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="username" autocomplete="username"
                                   class="form-control registry__username" placeholder="Uživatelské jméno"
                                   aria-label="Uživatelské jméno" aria-describedby="registry_username"
                                   required="required">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                            ...
                            <input type="text" name="name" autocomplete="name"
                                   class="form-control registry__name" placeholder="Vaše jméno"
                                   aria-label="Vaše jméno" aria-describedby="registry_name" required="required">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                            ...
                            <input type="password" name="password"
                                   class="form-control registry__password" placeholder="Heslo" aria-label="Heslo"
                                   aria-describedby="registry_password" required="required">
                        </div>
                        <div class="input-group mb-3">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon1"><i class="fas fa-lock"></i></span>
                            ...
                            <input type="password" name="password_re"
                                   class="form-control registry__password" placeholder="Heslo znovu"
                        ...
                        <div class="input-group teacher_password mb-3">
                            ...
                            <input type="email" name="email_teacher"
                                   class="form-control teacher__email" placeholder="E-mail"
                                   aria-label="E-mail"
                                   aria-describedby="email_teacher">
                        </div>
