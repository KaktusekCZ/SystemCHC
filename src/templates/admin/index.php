        ...
        <div class="admin__content col-10">
            ...
            <div class="admin__bar">
                <div class="admin__bar__status">
                    <div class="admin__bar__item admin__bar__item--type"><span><i
                                    class="fas fa-user"></i> Typ účtu</span> <?php getAccountType($row["type"]); ?>
                    </div>
                    <div class="admin__bar__item admin__bar__item--name"><span><i
                                    class="fas fa-check"></i> Přihlášen</span> <?php echo $row["name"] ?></div>
                    <div class="admin__bar__item admin__bar__item--logout js-admin-logout">Odhlásit se <i
